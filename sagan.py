...
class _Generator(nn.Module):
    def __init__(self, input_channels, output_channels, last_nonlinear):
        ...
        self.conv = nn.Sequential(
            ...
            # get_nonlinear('relu'),
            nn.Conv2d(input_channels, 32, 7, 1, 4, dilation=2),  # n_in, n_out, kernel_size, stride, padding
            get_norm('instancenorm', 32),
            get_nonlinear('relu'),
            nn.Conv2d(32, 64, 4, 2, 5, dilation=2),
            get_norm('instancenorm', 64),
            get_nonlinear('relu'),
            nn.Conv2d(64, 128, 4, 2, 3, dilation=2),
            get_norm('instancenorm', 128),
            get_nonlinear('relu'),
            nn.Conv2d(128, 256, 4, 2, 3, dilation=2),
            get_norm('instancenorm', 256),
            get_nonlinear('relu'),
        )
        ...
        self.deconv = nn.Sequential(
            nn.ConvTranspose2d(256, 128, 4, 2, 3, dilation=2),
            get_norm('instancenorm', 128),
            get_nonlinear('relu'),
            nn.ConvTranspose2d(128, 64, 4, 2, 2, dilation=2),
            get_norm('instancenorm', 64),
            get_nonlinear('relu'),
            nn.ConvTranspose2d(64, 32, 4, 2, 1),
            get_norm('instancenorm', 32),
            get_nonlinear('relu'),
            nn.ConvTranspose2d(32, output_channels, 7, 1, 5, dilation=2),
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(3, 32, 4, 2, 1, dilation=2),
            get_nonlinear('lrelu'),
            nn.Conv2d(32, 64, 4, 2, 1, dilation=2),
            get_nonlinear('lrelu'),
            nn.Conv2d(64, 128, 4, 2, 4, dilation=2),
            get_nonlinear('lrelu'),
            nn.Conv2d(128, 256, 4, 2, 3, dilation=2),
            get_nonlinear('lrelu'),
            nn.Conv2d(256, 512, 4, 2, 3, dilation=2),
            get_nonlinear('lrelu'),
            nn.Conv2d(512, 1024, 4, 2, 3, dilation=2),
            get_nonlinear('lrelu'),
        )
        self.src = nn.Conv2d(1024, 1, 3, 1, 2, dilation=2)
